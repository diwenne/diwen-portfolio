      ...
      <div className="relative z-10 mx-auto max-w-screen-sm px-6 sm:px-0">
        ...
        <div className="text-sm sm:text-base leading-tight space-y-3">
          ...
          <div className="py-1">
            ...
            helooo! im diwen; im from vancouver. im big on racquet sports – i play badminton and most the stuff i build is for racquet sports. i like math and physics too. i started coding in grade 9 (pretty late start) and i think its p nice. anywho, i hope you find what you're looking for here!
          </div>
        ...
        <div className="text-sm sm:text-base leading-tight space-y-3">
          ...
          <div>↳ documenting my life on <a href="https://www.instagram.com/devdiwen/" target="_blank" rel="noreferrer" className="hover-underline-nudge">instagram reels</a> — plz follow me :)</div>
          {/* 
